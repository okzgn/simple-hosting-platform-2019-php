...
HTML;
	...
	$S = '';
	$H = '<h1>Consola de órdenes de compra<a href="/orders/panel">SALIR &raquo;</a></h1>';
	require('cfg/docs/orders.panel.logged.php');
}
...
<head>
	...
	<meta name="description" content="Consola de órdenes de compra">
