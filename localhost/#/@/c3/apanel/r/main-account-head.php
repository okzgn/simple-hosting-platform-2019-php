...
form { width: 50%; }
fieldset { margin: 0 0.25rem; }
form fieldset { margin-top: 1rem; }
form:last-child fieldset { margin-bottom: 1rem; }
@media screen and (max-width: 640px){
	main { flex-wrap: wrap; }
	form { width: 100%; }
	form:first-child fieldset { margin-top: 0; }
}
legend h3 { display: inline-block; }
legend a {
	color: #666;
	text-transform: none;
	text-shadow: none;
